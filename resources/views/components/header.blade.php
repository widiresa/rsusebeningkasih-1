  <header class="navbar navbar-expand-lg bg-white shadow-sm sticky-top">
    <div class="container">
      <a class="navbar-brand" href="/">
        <img alt="RSU Sebening Kasih" src="{{ asset('img/logo.png') }}" height="56">
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <ul class="navbar-nav ms-auto">
          ...
          {{-- <li class="nav-item dropdown me-2">
            <a class="nav-link dropdown-toggle fw-semibold {{ request()->is('informasi/*') ? 'active' : '' }}" data-bs-toggle="dropdown" href="#">Informasi</a>
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="/informasi/jadwal-dokter">Jadwal Dokter</a></li>
              <li><a class="dropdown-item" href="/informasi/ketersediaan">Ketersediaan Tempat Tidur</a></li>
            </ul>
          </li> --}}
          {{-- <li class="nav-item me-2">
